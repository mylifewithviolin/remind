...
namespace remind.target.java
{
    public partial class TargetJava
    {
        ...
        private class SourceLineNodeKind{
            ...
            public const string PackageStNote ="□パッケージ";//パッケージ文
        ...
        private class TargetSourceLineNodeKind{
            ...
            public const string SglComentNote ="//";
            public const string JavDocComBeginNote ="/**";
            public const string JavDocComMidNote ="* jp";
            public const string JavDocComParmNote ="@param en jp";
            public const string JavDocComEndNote ="*/";
        }
