...
public partial class TargetJava
{
        ...
        private static void initNameDictionary(Dictionary<string, string> nameDictionary){
            nameDictionary.Add("パッケージ","package");
            nameDictionary.Add("クラス","class");
            nameDictionary.Add("インポートする","import");
            nameDictionary.Add("string","String");            
        }
                    ...
                    case NodeKind.ND_QAD_BEGIN://引用定義開始
                        ...
                        if(sourceLineString.IndexOf("class")>=0){
                            ...
                            if(keyValue.Length==2){
                                ...
                                nameDictionary.Add(keyValue[0],keyValue[2]);//3つの場合はインスタンス名が3つ目想定
                            }
                        }else{
